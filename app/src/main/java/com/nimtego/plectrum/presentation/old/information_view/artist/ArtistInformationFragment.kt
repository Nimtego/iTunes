...
import com.nimtego.plectrum.presentation.old.information_view.artist.adapter.AlbumsAdapterForArtist
...
class ArtistInformationFragment : BaseFragment(), ArtistInformationView {
...
companion object {
    fun newInstance(content: String): ArtistInformationFragment {
...
//    }
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.artist_information_fragment, container, false)
