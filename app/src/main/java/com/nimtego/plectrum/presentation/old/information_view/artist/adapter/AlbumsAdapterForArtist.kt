package com.nimtego.plectrum.presentation.old.information_view.artist.adapter
...
class AlbumsAdapterForArtist(private val models: List<AlbumModel>?, parent: Context) : RecyclerView.Adapter<AlbumsAdapterForArtist.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (this@AlbumsAdapterForArtist.onItemClickListener != null) {
                this@AlbumsAdapterForArtist.onItemClickListener!!.onUserItemClicked(albumModel)
            }
        }
