...
class SongInformationFragmentK : BaseFragmentK(), SongInformationView  {
...
companion object {
    fun newInstance(content: String): SongInformationView {
        val fragment = SongInformationFragmentK()
...
//    override fun supplyPresenter(): SongInformationContract.Presenter<*, *> {
//        return SongInformationPresenter()
//    }

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.information_song_form, container, false)
    ...
    override fun render(songDetailsModel: SongDetailsModelK) {
