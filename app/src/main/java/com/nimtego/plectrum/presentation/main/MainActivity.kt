...
import com.nimtego.plectrum.presentation.main.adapter.MainPagerAdapter
...
class MainActivity : MvpAppCompatActivity(), MainView {
    ...
    private var mViewPagerAdapter: MainPagerAdapter? = null
    ...
    private fun setupViewPager(savedInstanceState: Bundle?) {
        ...
        mViewPagerAdapter = MainPagerAdapter(this, fm)
        //todo search NULL
