...
@Deprecated("The old solution to remove when it stops being useful")
abstract class MainTabsFragment : BaseFragment(), MainTabsView {
    ...
    protected fun initRV(view: View, viewGroup: ViewGroup?) {
        mRecyclerView = view.findViewById(R.id.recycler_view_more_section)
