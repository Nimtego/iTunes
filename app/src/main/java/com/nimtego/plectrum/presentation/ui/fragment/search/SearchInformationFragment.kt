...
class SearchInformationFragment : BaseFragment(), InformationView, BackButtonListener {
...
//Mark: view override
    ...
    companion object {
        fun getInstance(navigationQualifier: String): SearchInformationFragment {
            val fragment = SearchInformationFragment()
