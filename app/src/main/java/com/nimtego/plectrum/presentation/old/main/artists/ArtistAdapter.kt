...
class ArtistAdapter(private val models: List<ArtistModel>?, parent: Context)
    : RecyclerView.Adapter<ArtistAdapter.ViewHolder>() {

    private var onItemClickListener: OnItemClickListener? = null

    interface OnItemClickListener {
        fun onUserItemClicked(artistModel: ArtistModel)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (this@ArtistAdapter.onItemClickListener != null) {
                this@ArtistAdapter.onItemClickListener!!.onUserItemClicked(artistModel)
            }
        }
