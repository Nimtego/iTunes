...
class TopAlbumAdapter(private val models: List<Album>?, parent: Context) : RecyclerView.Adapter<TopAlbumAdapter.ViewHolder>() {
    private var onItemClickListener: OnItemClickListener? = null

    interface OnItemClickListener {
        fun onUserItemClicked(albumModel: Album)
    }
