...
class AlbumInformationFragment : BaseFragment(), AlbumInformationView {
    ...
    companion object {
        fun newInstance(content: String): AlbumInformationFragment {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.album_information_fragment, container, false)
    ...
    override fun render(albumDetailsModel: AlbumDetailsModel) {
